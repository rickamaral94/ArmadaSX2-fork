...
val EN: Map<String, String> = mapOf(
    ...
    "perf.lsfg.requirements.body" to "Frame generation uses Lossless Scaling\u2019s own interpolation shaders. ArmadaSX2 does not include them \u2014 you must own Lossless Scaling and supply its Lossless.dll yourself.\n\nIt also requires the Vulkan renderer and an Adreno 7xx or newer GPU. On anything else it stays off.",
