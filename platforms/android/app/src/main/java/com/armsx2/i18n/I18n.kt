...
val EN: Map<String, String> = mapOf(
    ...
    "renderer.gsDumpSeq.description" to "Records 600 frames of GPU commands (.gs) to the snaps folder. Replaying it is deterministic, so renderer settings can be A/B tested on identical frames. Stops on its own; the file is larger than a single-frame dump.",
    "renderer.gsDumpSeq.queued" to "Recording 600 frames — close this menu and play the scene you want measured. It stops by itself and saves to the snaps folder.",
