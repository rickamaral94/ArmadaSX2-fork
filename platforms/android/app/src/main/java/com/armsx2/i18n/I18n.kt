...
val EN: Map<String, String> = mapOf(
    ...
    "overlay.osdSize.description" to "Size of the on-screen display drawn over the game — FPS, stats and notifications. Does not affect the app's menus. 100% = PCSX2's default; ARMSX2 ships 65% so it doesn't crowd a handheld screen.",
    ...
    "patches.bundled.header" to "Bundled with ARMSX2",
    "patches.bundled.explain" to "These ship inside ARMSX2 and are applied to this game automatically — you didn't install them. Ones with no name are always on and can't be switched off individually.",
