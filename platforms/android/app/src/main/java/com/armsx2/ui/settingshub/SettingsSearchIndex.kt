...
internal val SETTINGS_SEARCH_INDEX: List<SettingsSearchEntry> = listOf(
    ...
    SettingsSearchEntry("perf.fix.skipMpeg", true, SettingsCategory.Advanced),
    SettingsSearchEntry("perf.fix.fmvSoftware", true, SettingsCategory.Advanced),
    ...
    SettingsSearchEntry("perf.fix.vif1Stall", true, SettingsCategory.Advanced),
    SettingsSearchEntry("perf.fix.iBit", true, SettingsCategory.Advanced),
    SettingsSearchEntry("perf.fix.fullVu0Sync", true, SettingsCategory.Advanced),
    SettingsSearchEntry("perf.fix.vuAddSub", true, SettingsCategory.Advanced),
    SettingsSearchEntry("perf.fix.vuOverflow", true, SettingsCategory.Advanced),
    SettingsSearchEntry("perf.fix.extraXgkick", true, SettingsCategory.Advanced),
    SettingsSearchEntry("perf.fix.goemonTlb", true, SettingsCategory.Advanced),
    SettingsSearchEntry("perf.fix.vuSync", true, SettingsCategory.Advanced),
    ...
    SettingsSearchEntry("perf.gamedbFixes.title", true, SettingsCategory.Advanced),
    ...
    SettingsSearchEntry("renderer.autoProgressive.label", true, SettingsCategory.Graphics),
    SettingsSearchEntry("perf.affinity.label", true, SettingsCategory.Performance),
    ...
    SettingsSearchEntry("EE (R5900)", false, SettingsCategory.Advanced),
    SettingsSearchEntry("IOP (R3000)", false, SettingsCategory.Advanced),
