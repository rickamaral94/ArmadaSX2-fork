...
namespace
{
	...
	constexpr std::array<OptionDesc, OPTION_COUNT> OPTIONS = {{
		...
		{Option::FrameGenBudgetMs, "FrameGen.BudgetMs", Type::Float, false, 0, 8.0f, "",
			"Teto de tempo para gerar um quadro, em ms. Medido no Adreno 740: ~6,5 ms em cena leve, ~16 ms em cena pesada."},
