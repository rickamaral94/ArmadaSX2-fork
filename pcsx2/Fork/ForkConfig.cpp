...
namespace
{
	...
	constexpr std::array<OptionDesc, OPTION_COUNT> OPTIONS = {{
		...
		{Option::FrameGenBudgetMs, "FrameGen.BudgetMs", Type::Float, false, 0, 20.0f, "",
			"Teto absoluto de tempo para gerar um quadro, em ms. Só morde quando o intervalo real é muito longo; o orçamento de verdade é FrameGen.BudgetFraction."},
		{Option::FrameGenMinSpeedPercent, "FrameGen.MinSpeedPercent", Type::Float, false, 0, 90.0f, "",
		...
		{Option::FrameGenBudgetHysteresis, "FrameGen.BudgetHysteresis", Type::Float, false, 0, 0.25f, "",
			"Histerese do orçamento, como fração do teto."},
		{Option::FrameGenBudgetFraction, "FrameGen.BudgetFraction", Type::Float, false, 0, 0.5f, "",
			"Fração do intervalo real que a geração pode consumir. Cabe no tempo que existe, e o tempo depende de o jogo desenhar a 30 ou a 60."},
		{Option::FrameGenCooldownFrames, "FrameGen.CooldownFrames", Type::Int, false, 30, 0.0f, "",
